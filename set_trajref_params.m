...
switch (roadmap_name)
    ...
    case 'small_circle'
        ...
        simulation_stop_y = 40;     %当车辆y坐标值大于30时，仿真停止
        simulation_stop_time = 120 / veh_params.velocity; %仿真总时间, s
    ...
    case 'big_circle'
        ...
        trajref_params.r5 = 15;
        trajref_params.traj6_dist = 30;
        
        simulation_stop_y = 80;
        simulation_stop_time = 240 / veh_params.velocity;
    otherwise
